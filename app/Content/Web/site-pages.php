        ...
        'es' => [
            ...
            'legal-notice' => [
                ...
                'actions' => [
                    ...
                    ['label' => 'Terminos de apoyo', 'href' => with_lang(page_url('support-terms')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-hand-holding-heart'],
            ...
            'support-terms' => [
                ...
                'actions' => [
                    ...
                    ['label' => 'Cookies', 'href' => with_lang(page_url('cookies')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-cookie-bite'],
                    ['label' => 'Pagos', 'href' => with_lang(page_url('payment-disclaimer')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-credit-card'],
                    ['label' => 'Terminos de apoyo', 'href' => with_lang(page_url('support-terms')), 'variant' => 'primary', 'external' => false, 'icon' => 'fas fa-hand-holding-heart'],
                    ['label' => 'Contactar', 'href' => with_lang(page_url('contact')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-envelope', 'align' => 'end'],
                ],
            ],
            'class-select' => [
        ...
        'en' => [
            ...
            'legal-notice' => [
                ...
                'actions' => [
                    ...
                    ['label' => 'Support terms', 'href' => with_lang(page_url('support-terms')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-hand-holding-heart'],
            ...
            'support-terms' => [
                ...
                'actions' => [
                    ...
                    ['label' => 'Cookies', 'href' => with_lang(page_url('cookies')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-cookie-bite'],
                    ['label' => 'Payments', 'href' => with_lang(page_url('payment-disclaimer')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-credit-card'],
                    ['label' => 'Support terms', 'href' => with_lang(page_url('support-terms')), 'variant' => 'primary', 'external' => false, 'icon' => 'fas fa-hand-holding-heart'],
                    ['label' => 'Contact', 'href' => with_lang(page_url('contact')), 'variant' => 'ghost', 'external' => false, 'icon' => 'fas fa-envelope', 'align' => 'end'],
                ],
            ],
            'class-select' => [
