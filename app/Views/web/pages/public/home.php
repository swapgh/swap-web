...
<main class="portfolio-page">
  ...
  <section class="games-section" id="featured-games">
    <div class="container">
      <div class="section-heading section-heading-compact reveal-item"><h2><?= e($home['games']['title']) ?></h2></div>
        ...
        <?php foreach ($home['games']['cards'] as $card): ?>
          ...
          <article class="game-card reveal-item" data-filter-item data-tag="<?= e(implode(' ', $card['platform_tags'])) ?>">
            ...
            <div class="game-card-body">
              <div class="game-card-topline"><h3><?= e($card['name']) ?></h3><span class="featured-platform"><?= e($card['platform_label']) ?></span></div>
  ...
  <section class="hero-banner">
    <div class="container">
      <div class="hero-copy reveal-item" style="background-image: linear-gradient(180deg, rgba(8, 12, 20, 0.42), rgba(8, 12, 20, 0.76)), url('<?= e(asset_url($home['hero']['background_image'])) ?>');">
        ...
        <div class="hero-chip-row"><?php foreach ($home['hero']['chips'] as $chip): ?><span class="hero-chip"><?= e($chip) ?></span><?php endforeach; ?></div>
        ...
        <div class="hero-stats"><?php foreach ($home['hero']['stats'] as $stat): ?><article class="stat-card"><strong><?= e($stat['value']) ?></strong><span><?= e($stat['label']) ?></span></article><?php endforeach; ?></div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="intro-feature-card reveal-item">
        <div class="intro-copy">
          ...
          <div class="hero-actions hero-actions-left">
            <a class="btn btn-primary" href="<?= e(with_lang(page_url('projects/swap-rpg'))) ?>"><i class="fas fa-arrow-right"></i><span><?= e($home['intro_feature']['primary_cta']) ?></span></a>
            <a class="btn btn-secondary" href="<?= e(with_lang(page_url('contact'))) ?>"><i class="fas fa-envelope"></i><span><?= e($home['intro_feature']['secondary_cta']) ?></span></a>
          </div>
        </div>
        <aside class="intro-side"><ul class="intro-points"><?php foreach ($home['intro_feature']['points'] as $point): ?><li><?= e($point) ?></li><?php endforeach; ?></ul></aside>
      </div>
    </div>
  </section>
</main>
