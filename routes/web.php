...
return static function (\App\Core\Router $router): void {
    ...
    $router->post('/billing/checkout', [BillingController::class, 'checkout'], [RequireAuth::class]);
    $router->get('/billing/history', [BillingController::class, 'history'], [RequireAuth::class]);
